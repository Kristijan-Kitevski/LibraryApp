...
INSERT INTO 
LibraryBranches(ImgUrl, [Address], [BranchName], [Phone], OpenDate, [Description]) 
VALUES 
...
INSERT INTO 
Patrons([Adress], DateOfBirth, FirstName, HomeLibraryBranchId, LastName, LibraryCardId, TelephoneNumber) VALUES
...
(Discriminator, Cost, LocationId, StatusId, Author, DeweyIndex, ISBN, Title, [Year], Director, ImgUrl, NumbOfCopies) VALUES
